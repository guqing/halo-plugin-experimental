 ...
 * @since 2021-11-06
 */
public class PluginApplicationListenerMethodAdapter implements GenericApplicationListener {
    ...
    @Nullable
    private PluginEventExpressionEvaluator evaluator;
     ...
     */
    public PluginApplicationListenerMethodAdapter(String beanName, Class<?> targetClass,
        Method method) {
    ...
    public void init(ApplicationContext applicationContext,
        @Nullable PluginEventExpressionEvaluator evaluator) {
    ...
    /**
     * Determine the default id for the target listener, to be applied in case of no {@link
     * EventListener#id() annotation-specified id value}.
     ...
     * Can return {@code null} to indicate that no suitable arguments could be resolved and
    ...
    protected Object doInvoke(Object... args) {
        ...
        try {
            ...
            throw new IllegalStateException(getInvocationErrorMessage(bean, ex.getMessage(), args),
                ex);
     ...
     * annotation or any matching attribute on a composed annotation that is meta-annotated with
     * {@code @EventListener}.
     */
    @Nullable
    ...
    /**
     * Add additional details such as the bean type and method signature to the given error
     * message.
     *
